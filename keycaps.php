<html>
    <head>
        ...
        <body style="background-color: rgb(239, 239, 239);">
          <b style="position:absolute;top: 170px; right: 580px;
        font-family: Comfortaa;font-size: 80px;">Keycaps</b>
        <form name="cart" action="addtocart.php" method="post">
          <input type="hidden" name="url" value="keycaps.php">
...
from product_description where type = 'keycaps'";
//Database Connection
