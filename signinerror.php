...
<body style="background-color: rgb(223, 224, 226);">
        ...
        <br><br><br>
                <div>
                    ...
                    style="border: 2px solid red;" class="r-textbox"></center>
                    </div><br><br>
                    <div>
                        <font class="registration">Password:</font><br><br>
                    <center><input type="password" name="password" id="myInput" class="r-textbox" 
                    style="border: 2px solid red;"></center>
                    <br>&emsp;&emsp;&emsp;
                    &emsp;&emsp;&emsp;
                    <input type="checkbox"  onclick="myFunction()"><font style="font-family:'Open sans';">
                      Show Password<font>
                    <p style="color:red;font-family:Comfortaa;position: absolute;left: 100;"
                    >Username or password was invalid.</p>
                    </div><br><br>
                <div> 
                    <center><button onclick="submitForm()" class="signinbtn">Login</button></center><br>
                    <center class="question">Don't have an account? <a href="registration.php">Register now!</a></center>
                </div>       
        </div>      
    </form>     
    </body>
