...
<body style="background-color: rgb(239, 239, 239);">
        <b style="position:absolute;top: 170px; right: 370px;
        font-family: Comfortaa;font-size: 80px;">Wired Keyboards</b>
        <form name="cart" action="addtocart.php" method="post">
          <input type="hidden" name="url" value="wired.php">
...
from product_description where type = 'wired'";
//Database Connection
