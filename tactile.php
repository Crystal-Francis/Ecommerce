<html>
    <head>
        ...
        font-family: Comfortaa;font-size: 80px;">Tactile Switches</b>

<form name="cart" action="addtocart.php" method="post">
          <input type="hidden" name="url" value="tactile.php">
...
from product_description where type = 'tactile'";
//Database Connection
