<html>
    <head>
        ...
        <title>Hotswappable Keyboards</title>
...
function sendToCart(prod_desc_id) {
  ...
  document.cart.submit();
    ...
    <body style="background-color: rgb(239, 239, 239);">
        <b style="position:absolute;top: 170px; right: 200px;
        font-family: Comfortaa;font-size: 80px;">Hotswappable Keyboards</b>
        <form name="cart" action="addtocart.php" method="post">
          <input type="hidden" name="url" value="hotswp.php">
...
from product_description where type = 'hotswappable'";
//Database Connection
