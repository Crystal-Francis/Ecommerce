...
function sendToCart(prod_desc_id) {
  ...
  document.cart.submit();
    ...
    <form name="cart" action="addtocart.php" method="post">
      <input type="hidden" value="wireless.php" name="url">
    <input type="hidden" name = "id">     
    <?php include 'header.php'?>
        <b style="position:absolute;top: 170px; right: 320px;
        font-family: Comfortaa;font-size: 80px;">Wireless Keyboards</b>
...
from product_description where type = 'wireless'";
//Database Connection
...
<div class="product1" style="right: <?=$rloc;?>px; top: <?=$tloc;?>px; width: 350px;">
            <center><br><br><img src="./images/<?=$row["image"]; ?>" style="height: 177px;"
