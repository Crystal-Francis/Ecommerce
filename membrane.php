<html>
    ...
    <body style="background-color: rgb(239, 239, 239);">
        <b style="position:absolute;top: 170px; right: 280px;
        font-family: Comfortaa;font-size: 80px;">Membrane Keyboards</b>
        <form name="cart" action="addtocart.php" method="post">
          <input type="hidden" name="url" value="membrane.php">
...
from product_description where type = 'membrane'";
//Database Connection
